...
#define MPU6050_IIC_SCL_Pin                GPIO_Pin_0	         //PB10
#define MPU6050_IIC_SDA_Pin                GPIO_Pin_1	         //PB11

#define	MPU6050_IIC_SCL                    PBout(0)
#define	MPU6050_IIC_SDA                    PBout(1)  
#define	MPU6050_IIC_SDA_IN                 PBin(1)              //读数据端口
